...
Рис. 1. Пример вертикального шардинга. Когда одна таблица разбивается на несколько маленьких, содержащих такое же количество строк, но меньшее количество столбцов.
![vert](./img/1.PNG)
